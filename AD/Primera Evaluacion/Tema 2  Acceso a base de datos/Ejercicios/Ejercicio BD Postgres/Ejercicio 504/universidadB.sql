...
ALTER TABLE objetos.Inscripciones
ADD COLUMN profesor_id INT REFERENCES objetos.Profesores(profesor_id);

INSERT INTO objetos.Inscripciones (profesor_id, curso_id)
VALUES (1, 1); -- Inscribir al profesor con ID 1 en el curso con ID 1.
